...
<style>
:root{color-scheme:dark;--bg:#050607;--panel:#17181c;--panel2:#1f2026;--surface:#111318;--surface2:#101217;--sidebar:#020303;--line:#343640;--line-soft:#2a2d35;--text:#f5f7fb;--muted:#8e96a3;--nav-text:#d9dde7;--button-bg:#243b63;--button-text:#fff;--trace-bg:#222b2e;--trace-text:#e3dac5;--glass:rgba(5,6,7,.94);--tab-glass:rgba(9,10,12,.96);--pill-bg:#11351f;--pill-text:#68f0a4;--upload:#46a6ff;--download:#20d98a;--total:#b779ff;--blue:#0877ff;--green:#1ddb78;--orange:#ff9f1a;--purple:#8e4cff;--danger:#ff5a66}
:root[data-theme=light]{color-scheme:light;--bg:#f4f6f9;--panel:#fff;--panel2:#fff;--surface:#f8fafc;--surface2:#fff;--sidebar:#fff;--line:#d7dde7;--line-soft:#e6eaf0;--text:#172033;--muted:#697487;--nav-text:#3f4a5c;--button-bg:#e7eef8;--button-text:#25334a;--trace-bg:#152126;--trace-text:#f1eadb;--glass:rgba(255,255,255,.94);--tab-glass:rgba(255,255,255,.96);--pill-bg:#e4f6ec;--pill-text:#087a4d;--upload:#176fc1;--download:#087a4d;--total:#7138c7;--green:#087a4d;--purple:#7138c7;--danger:#e23f4d}
@media(prefers-color-scheme:light){:root[data-theme=system]{color-scheme:light;--bg:#f4f6f9;--panel:#fff;--panel2:#fff;--surface:#f8fafc;--surface2:#fff;--sidebar:#fff;--line:#d7dde7;--line-soft:#e6eaf0;--text:#172033;--muted:#697487;--nav-text:#3f4a5c;--button-bg:#e7eef8;--button-text:#25334a;--trace-bg:#152126;--trace-text:#f1eadb;--glass:rgba(255,255,255,.94);--tab-glass:rgba(255,255,255,.96);--pill-bg:#e4f6ec;--pill-text:#087a4d;--upload:#176fc1;--download:#087a4d;--total:#7138c7;--green:#087a4d;--purple:#7138c7;--danger:#e23f4d}}
