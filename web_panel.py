...
body{font-size:14px;overflow-x:hidden}.app{display:block;min-height:100dvh}.side{position:fixed;z-index:8;inset:auto 0 0 0;width:auto;height:calc(66px + env(safe-area-inset-bottom));padding:0 8px env(safe-area-inset-bottom);border:0;border-top:1px solid #2a2d35;background:rgba(9,10,12,.96);backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px)}.brand,.ver,.foot{display:none}.nav{height:66px;display:grid;grid-template-columns:repeat(5,minmax(0,1fr));align-items:stretch}.nav button{min-width:0;width:auto;height:66px;margin:0;padding:7px 2px 6px;border-radius:0;display:flex;flex-direction:column;justify-content:center;align-items:center;gap:3px;text-align:center;color:#9299a6;font-size:11px;line-height:1.15;background:transparent}.nav button.active{background:transparent;color:#3193ff}.nav-icon{display:block;font-size:21px;line-height:22px;font-weight:500}.main{margin:0;min-width:0}.top{position:sticky;z-index:4;top:0;height:50px;padding:0 14px;justify-content:space-between;background:rgba(5,6,7,.94);backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px)}.mobile-brand{display:block;max-width:70%}.user{font-size:12px;color:var(--muted)}.content{padding:12px 12px calc(84px + env(safe-area-inset-bottom))}.cards{grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.card{min-height:116px;padding:13px}.card h3{margin-bottom:10px;font-size:12px}.big{font-size:19px;overflow-wrap:anywhere}.bar{margin-top:11px}.panel{margin-top:12px;padding:12px;border-radius:8px}.panel h2{font-size:18px;margin-bottom:12px}.toolbar{align-items:stretch;flex-wrap:wrap;gap:8px;margin-bottom:12px}.toolbar h2{width:100%;margin:0!important}.toolbar button{min-height:42px;flex:1;padding:9px 8px}.rules-toolbar .view-switch{width:100%}.rules-toolbar .view-switch button{min-height:38px}.grid{grid-template-columns:1fr;gap:0}.field>.actions{display:grid;grid-template-columns:1fr auto;align-items:stretch}.field>.actions button{min-height:44px}.rule-grid{grid-template-columns:1fr}.rule-card{padding:14px}.rule-card .actions{display:grid;grid-template-columns:1fr 1fr;gap:10px}.rule-card .actions button{min-height:40px}.chart-svg{height:205px}.rule-table-wrap{border:0;overflow:visible}.table,.table tbody,.table tr,.table td{display:block;width:100%}.table thead{display:none}.table tbody{display:grid;gap:10px}.table tr{padding:10px 12px;border:1px solid var(--line);border-radius:8px;background:#111318}.table td{min-height:34px;padding:7px 0;border:0;display:grid;grid-template-columns:minmax(86px,35%) minmax(0,1fr);gap:10px;align-items:center;text-align:right;overflow-wrap:anywhere}.table td:before{content:attr(data-label);color:var(--muted);font-size:12px;text-align:left}.table td.actions{display:flex;justify-content:flex-end;flex-wrap:wrap;padding-top:10px;border-top:1px solid #2a2d35;margin-top:4px}.table td.actions:before{margin-right:auto}.table td.actions button{min-height:38px}.table td[colspan]{display:block;text-align:center;color:var(--muted)}.table td[colspan]:before{display:none}.probe-pill{margin-left:auto}.dialog{width:calc(100vw - 24px);max-width:none;max-height:calc(100dvh - 28px);padding:16px;border-radius:9px;overscroll-behavior:contain}.dialog.trace-dialog,.dialog.rules-dialog{width:calc(100vw - 16px)}.dialog h2{font-size:20px;margin-top:0}.dialog-actions{position:sticky;bottom:-16px;margin:16px -16px -16px;padding:12px 16px calc(12px + env(safe-area-inset-bottom));display:flex;justify-content:flex-end;gap:9px;background:var(--panel2);border-top:1px solid var(--line)}.dialog-actions button{min-width:92px;min-height:42px}.trace-output{max-height:58dvh;padding:10px;font-size:11px}.field input,.field select,.field textarea{font-size:16px;min-height:44px}.field textarea{min-height:88px}.firewall-check{min-height:46px}.toast{left:12px;right:12px;top:calc(10px + env(safe-area-inset-top));max-width:none}.login{min-height:100dvh;height:auto;padding:18px}.login form{width:100%;max-width:360px;padding:22px}.login input{font-size:16px}.pill{max-width:100%;overflow-wrap:anywhere}.content>.panel:first-child{margin-top:0}
}
